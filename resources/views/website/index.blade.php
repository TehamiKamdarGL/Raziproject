        ...
        <div class="row no-gutters slider-text js-fullheight justify-content-center align-items-center">
          <div class="col-lg-12 ftco-animate d-flex align-items-center">
          	<div class="text text-center">
          		<span class="subheading">Welcome to Elegance Salon</span>
		  				<h1 class="mb-4">We are professional care for your hair</h1>
		  				<p><a href="/booknow" class="btn btn-primary btn-outline-primary px-4 py-2">Book now</a></p>
							</div>
            </div>
          </div>
        </div>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt">
			<div class="container">
	          ...
	          <div class="heading-section mb-4 mt-md-5">
	            ...
	            <h2 class="mb-4">Welcome To Elegance Salon</h2>
	          </div>
	          <div class="pb-md-5">
